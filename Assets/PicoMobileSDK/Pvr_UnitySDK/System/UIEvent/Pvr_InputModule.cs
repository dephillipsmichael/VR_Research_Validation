...
public class Pvr_InputModule : PointerInputModule
{
    ...
    public override void Process()
    {
        if (Pvr_UnitySDKManager.SDK.isHasController)
        {
            ...
            {
                Pvr_UIPointer.TouchBtnValue = Pvr_UnitySDKAPI.Controller.UPvr_GetKey(Pvr_ControllerManager.controllerlink.mainHandID, Pvr_UnitySDKAPI.Pvr_KeyCode.TRIGGER);
            }
